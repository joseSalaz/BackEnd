...
namespace API.Controllers
{
  ...
  public class AutorController : ControllerBase
  {
    ...
    /// Filtra
    /// </summary>
    /// <param name="idCategoria,idSubcategoria">Valor de los parametros</param>
    /// <returns>Devuelve los autores por categorias</returns>
    [HttpGet("CatAutor")]
    public async Task<IActionResult> GetAutorCategoria(int idCategoria, int? idSubcategoria)
    {
      var ca = await _IAutorBussines.GetAutorCategoria(idCategoria, idSubcategoria);
      return Ok(ca);
    }
    #endregion
  }
