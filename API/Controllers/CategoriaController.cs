...
namespace API.Controllers
{
  ...
  public class CategoriaController : ControllerBase
  {
    ...
    #region constructor 
    public CategoriaController(ICategoriaBussines categoriaBussines)
    {
      _ICategoriaBussines = categoriaBussines;
    }
    #endregion
    ...
    public async Task<IActionResult> GetLibrosByCategoriaId(int categoriaId)
    {
      ...
      {
        return NotFound(new { success = false, message = "No se encontraron libros para esta categoría" });
      }

      // Opcional: Retornarlo dentro de una estructura estándar para que Angular lo consuma mejor
