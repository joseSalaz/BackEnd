...
namespace API.Controllers
{
  ...
  public class LibroController : ControllerBase
  {
    ...
    [HttpPost("Filtrar/autor/proveedor/precio")]
    public async Task<IActionResult> Filtrar([FromBody] FiltroLibroRequest request)
    {
      var result = await _ILibroBussines.FiltrarLibros(request);
