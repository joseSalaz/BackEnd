    ...
    public class PaypalController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreatePayment([FromBody] PaymentCreationRequest paymentRequest)
        {
            try
            {
                ...
                string returnUrl = $"{_configuration[" https://libreriasaber.store/detalle-venta "]}/respuesta"; // Esta debe ser la URL de tu frontend a donde PayPal redirige después del pago exitoso
                string cancelUrl = $"{_configuration[" https://libreriasaber.store/detalle-venta "]}/respuesta"; // Esta debe ser la URL de tu frontend a donde PayPal redirige si el usuario cancela el pago
