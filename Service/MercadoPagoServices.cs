  ...
  public async Task<string> CreatePaymentAsync(DatalleCarrito detalleCarrito, decimal total)
  {
    ...
    var request = new PreferenceRequest
    {
      ...
      Payer = new PreferencePayerRequest
      {
        ...
        {
          AreaCode = "51", // Cambia según la lógica de tu aplicación
      ...
      NotificationUrl = "http://localhost:5229/webhook", // Cambia esto a tu URL de webhook real
      Expires = true,
      ExpirationDateFrom = DateTime.UtcNow, // Usa el tiempo presente exacto sin restar minutos
      ExpirationDateTo = DateTime.UtcNow.AddHours(2) // Dale un margen corto, 1 o 2 horas es ideal para Yape
    };
